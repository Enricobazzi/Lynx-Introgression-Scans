...
for k in {1..8}
 do
  ...
  out=/mnt/netapp1/Store_csebdjgl/lynx_genome/lynx_data/LyCaRef_vcfs/lp_ll_introgression_${scaffold}_w${i}_w${k}_LyCa_ref.vcf
  bed=/mnt/netapp1/Store_csebdjgl/reference_genomes/Ref_Genome_LyCa/Scaffold_Partitions/${scaffold}_${i}/${scaffold}_w${i}_w${k}.bed
